...
# include <Rheinheart/Rheinheart.h>
# include <stdint.h>
# include <stddef.h>
...
void Rheinheart__method__kernel ( );

void
Rheinheart__method__kernel
...
{
	Rheinheart___class___ Rheinheart___mark___, * Rheinheart = & Rheinheart___mark___;
	
	(* Rheinheart). value = 10000000;
